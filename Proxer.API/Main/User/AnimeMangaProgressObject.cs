...
{
    /// <summary>
    /// Eine Klasse, die den Fortschritt eines <see cref="API.User">Benutzers</see> bei einem <see cref="Anime">Anime</see> oder <see cref="Manga">Manga</see> darstellt.
    /// </summary>
    public class AnimeMangaProgressObject
    {
        ...
        /// <summary>
        /// Gibt die maximale Anzahl der <see cref="Anime.Episode">Episoden</see> oder <see cref="Manga.Chapter">Kapitel</see> zurück, 
        ...
        /// <param name="animeMangaObject">Der <see cref="Anime">Anime</see> oder <see cref="Manga">Manga</see>, mit dem das Objekt zusammenhängt.</param>
        /// <param name="currentProgress">Der aktuelle Fortschritt.</param>
        /// <param name="maxCount">Die maximale Anzahl der <see cref="Anime.Episode">Episoden</see> oder <see cref="Manga.Chapter">Kapitel</see>.</param>
        /// <param name="progress">Die Kategorie, in der der <paramref name="user">Benutzer</paramref> seinen Fortschritt einsortiert hat.</param>
        public AnimeMangaProgressObject(API.User user, IAnimeMangaObject animeMangaObject, int currentProgress, int maxCount, AnimeMangaProgress progress)
        {
            this.User = user;
        ...
        /// <summary>
        /// Eine Aufzählung, die die Kategorie darstellt, in der der <see cref="API.User">Benutzer</see> seinen Fortschritt mit dem aktuellen 
