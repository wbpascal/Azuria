...
{
    /// <summary>
    /// Stellt einen Fehler da, der ausgelöst wird, wenn die Antwort des Servers bei einer Anfrage nicht mit der Erwarteten übereinstimmt.
    /// </summary>
    [Serializable]
    public class WrongResponseException : Exception
    {
        ...
        /// <summary>
        ///     Initialisiert eine neue Instanz der <see cref="WrongResponseException" />-Klasse mit einer angegebenen Fehlermeldung.
        /// </summary>
