...
namespace Azuria.User
{
    ...
    public class AnimeMangaProgressObject<T> where T : IAnimeMangaObject
    {
        ...
        /// </summary>
        /// <param name="user">The <see cref="Azuria.User.User" /> which the entry belongs to.</param>
        ...
        public AnimeMangaProgressObject([NotNull] User user, [NotNull] T animeMangaObject,
        ...
        public static async Task<AnimeMangaProgressObject<T>> GetEmptyProgressObjectFromAnimeMangaObject(
            [NotNull] T animeMangaObject, [NotNull] User user, [NotNull] Senpai senpai)
        {
        ...
        [NotNull]
        internal static AnimeMangaProgressObject<T> ParseFromHtmlNode([NotNull] HtmlNode node, User user,
