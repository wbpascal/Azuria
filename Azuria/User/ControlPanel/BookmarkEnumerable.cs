...
namespace Azuria.User.ControlPanel
{
    ...
    public class BookmarkEnumerable<T> : IEnumerable<AnimeMangaBookmarkObject<T>> where T : class, IAnimeMangaObject
    {
        ...
        public IEnumerator<AnimeMangaBookmarkObject<T>> GetEnumerator()
        {
