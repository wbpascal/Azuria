...
namespace Azuria.Api.v1.RequestBuilder
{
    ...
    public static class UcpRequestBuilder
    {
        ...
        /// <param name="senpai">The user of which the entry should be removed from the topten. Must be logged in.</param>
        /// <returns>An instance of <see cref="ApiRequest" /> that removes an entry from a users topten.</returns>
        /// <seealso cref="GetTopten" />
        public static ApiRequest DeleteFavourite(int favouriteId, Senpai senpai)
        {
        ...
        /// <param name="senpai">The user of which the reminder will be deleted. Must be logged in.</param>
        /// <returns>An instance of <see cref="ApiRequest" /> that deletes a reminder.</returns>
        /// <seealso cref="GetReminder" />
        public static ApiRequest DeleteReminder(int reminderId, Senpai senpai)
        {
            return ApiRequest.Create(new Uri($"{ApiConstants.ApiUrlV1}/ucp/deletereminder"))
                .WithCheckLogin(true)
                .WithPostArgument("id", reminderId.ToString())
                .WithSenpai(senpai);
        }
        ...
        /// <param name="senpai">The user of which the comment upvote should be removed. Must be logged in.</param>
        /// <returns>An instance of <see cref="ApiRequest" /> that removes a comment upvote.</returns>
        /// <seealso cref="GetVotes" />
        public static ApiRequest DeleteVote(int voteId, Senpai senpai)
        {
        ...
        /// * UCP - Level 0
        /// </summary>
        /// <param name="senpai">The user of which the history will be returned. Must be logged in.</param>
        ...
        public static ApiRequest<HistoryDataModel[]> GetHistory(Senpai senpai, int page = 0, int limit = 50)
        {
        ...
        /// * UCP - Level 0
        /// </summary>
        /// <param name="senpai">The user of which the anime or manga are returned. Must be logged in.</param>
        ...
        /// * UCP - Level 0
        /// </summary>
        /// <param name="senpai">The user of which the sum will be returned. Must be logged in.</param>
        /// <param name="kat">
        ...
        /// * UCP - Level 0
        /// </summary>
        /// <param name="senpai">The user of which the reminders should be returned. Must be logged in.</param>
        /// <param name="kat">
        ...
        public static ApiRequest<BookmarkDataModel[]> GetReminder(Senpai senpai, string kat = "", int page = 0,
            int limit = 100)
        {
        ...
        /// * UCP - Level 0
        /// </summary>
        /// <param name="senpai">The user of which the topten will be returned. Must be logged in.</param>
        ...
        /// * UCP - Level 0
        /// </summary>
        /// <param name="senpai">The user of which the comment votes will be returned. Must be logged in.</param>
        ...
        /// <param name="senpai">The user of which the progress will be edited. Must be logged in.</param>
        /// <returns>An instance of <see cref="ApiRequest" /> sets a users progress of an anime/manga.</returns>
        public static ApiRequest SetCommentState(int id, int progress, Senpai senpai)
        {
            return ApiRequest.Create(new Uri($"{ApiConstants.ApiUrlV1}/ucp/setcommentstate"))
                .WithCheckLogin(true)
                .WithPostArgument("id", id.ToString())
        ...
        /// </param>
        /// <param name="senpai">The user that creates the reminder. Must be logged in.</param>
