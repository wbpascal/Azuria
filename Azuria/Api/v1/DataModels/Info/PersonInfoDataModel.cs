...
namespace Azuria.Api.v1.DataModels.Info
{
    ...
    public class PersonInfoDataModel : DataModelBase
    {
        ...
        [JsonProperty("characters")] public CharacterDataModel[] Characters { get; set; }

        [JsonProperty("description")] public DescriptionDataModel[] Description { get; set; }

        [JsonProperty("entries")] public EntryDataModel[] Entries { get; set; }
        ...
        [JsonProperty("occupations")] public Occupation[] Occupations { get; set; }

        [JsonProperty("residence")] public string Residence { get; set; }

        [JsonProperty("sites")] public SiteDataModel[] Sites { get; set; }

        #region Subclasses

        public class CharacterDataModel : Info.CharacterDataModel
        {
            [JsonProperty("cid")] public new int Id { get; set; }
        ...
        {
            [JsonProperty("eid")] public int EntryId { get; set; }

            [JsonProperty("name")] public string EntryName { get; set; }
        ...
        {
            [JsonProperty("link")] internal string LinkText { get; set; }
