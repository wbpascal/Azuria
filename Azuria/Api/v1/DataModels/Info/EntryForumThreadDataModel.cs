...
namespace Azuria.Api.v1.DataModels.Info
{
    ...
    public class EntryForumThreadDataModel : IDataModel
    {
        ...
        [JsonProperty("first_post_userid")] public int FirstPostUserId { get; set; }
        ...
        [JsonProperty("last_post_userid")] public int LastPostUserId { get; set; }

        [JsonProperty("last_post_guest_name")] public string LastPostUserName { get; set; }

        [JsonProperty("posts")] public int PostCount { get; set; }
