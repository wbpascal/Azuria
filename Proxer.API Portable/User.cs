...
namespace Proxer.API
{
    public class User
    {
        ...
        private TimerCallback notificationsCallback;
        private TimerCallback loginCallback;
        ...
        public User()
        {
            ...
            this.loginCallback = this.checkLogin;
            this.notificationsCallback = this.checkNotifications;
        }
        ...
        public bool LoggedIn
        {
            ...
            private set
            {
                if (value)
                {
                    this.loginCheckTimer = new Timer(loginCallback, new Object(), new TimeSpan(0, 45, 0), new TimeSpan(0, 30, 0));
                    this.notificationTimer = new Timer(notificationsCallback, new Object(), new TimeSpan(0), new TimeSpan(0, 30, 0));
                    this.loggedIn = value;
                }
                else
                {
                    this.loginCheckTimer.Dispose();
        ...
        /// </summary>
        private async void checkLogin(object stateInfo)
        {
            if (LoggedIn)
            {
        ...
        /// </summary>
        private async void checkNotifications(object stateInfo)
        {
            if (LoggedIn)
            {
