...
namespace Azuria.Example.Android
{
    public class SenpaiParcelable : Object, IParcelable
    {
        ...
        ///             <a href="http://developer.android.com/reference/android/os/Parcelable.html#describeContents()"
        ///                 target="_blank">
        ...
        ///     May be 0 or
        ///     <c>
        ///         <see cref="F:Android.OS.Parcelable.ParcelableWriteReturnValue" />
        ///     </c>
        ///     .
        /// </param>
        ...
        ///         <format type="text/html">
        ///             <a
        ///                 href="http://developer.android.com/reference/android/os/Parcelable.html#writeToParcel(android.os.Parcel, int)"
        ///                 target="_blank">
        ///                 [Android Documentation]
        ///             </a>
        ///         </format>
    ...
    public class SenpaiParcelableCreator : Object, IParcelableCreator
    {
        ...
        ///     <c>
        ///         <see cref="!:Android.OS.Parcelable.writeToParcel(android.os.Parcel, int)" />
        ///     </c>
        ///     .
        /// </summary>
        /// <returns>To be added.</returns>
        ...
        ///         <format type="text/html">
        ///             <a
        ///                 href="http://developer.android.com/reference/android/os/Parcelable.Creator.html#createFromParcel(android.os.Parcel)"
        ///                 target="_blank">
        ///                 [Android Documentation]
        ///             </a>
        ///         </format>
        ...
        ///     <para tool="javadoc-to-mdoc">
        ///         <format type="text/html">
        ///             <a href="http://developer.android.com/reference/android/os/Parcelable.Creator.html#newArray(int)"
        ///                 target="_blank">
        ///                 [Android Documentation]
        ///             </a>
        ///         </format>
