...
----- | ----- | ------ | -----
[![Build status](https://img.shields.io/teamcity/http/ci.infinitesoul.me/s/Azuria_CiBuild.svg)](https://ci.infinitesoul.me/viewType.html?buildTypeId=Azuria_CiBuild&guest=1) | [![Build status](https://img.shields.io/teamcity/http/ci.infinitesoul.me/s/Azuria_DailyTests.svg)](https://ci.infinitesoul.me/viewType.html?buildTypeId=Azuria_DailyTests&guest=1) |[![Stories in Ready](https://badge.waffle.io/InfiniteSoul/azuria.svg?label=ready&title=Ready)](http://waffle.io/InfiniteSoul/azuria) | [![NuGet](https://img.shields.io/nuget/v/Azuria.svg)](https://www.nuget.org/packages/Azuria)
