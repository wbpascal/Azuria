...
------------- | ------ | -----
[![Build status](https://img.shields.io/teamcity/http/h2522652.stratoserver.net:8080/s/Azuria_CiBuild.svg)](http://h2522652.stratoserver.net:8080/viewType.html?buildTypeId=Azuria_CiBuild&guest=1) | [![Stories in Ready](https://badge.waffle.io/InfiniteSoul/azuria.svg?label=ready&title=Ready)](http://waffle.io/InfiniteSoul/azuria) | [![NuGet](https://img.shields.io/nuget/v/Azuria.svg)](https://www.nuget.org/packages/Azuria)
