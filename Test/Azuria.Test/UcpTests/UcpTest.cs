...
namespace Azuria.Test.UcpTests
{
    ...
    public class UcpTest
    {
        ...
        public void BookmarkAnimeTest()
        {
            ...
            Assert.IsTrue(lBookmarks.All(o =>
                !string.IsNullOrEmpty(o.MediaContentObject.ParentObject.Name.GetIfInitialised(string.Empty))));
            Assert.IsTrue(lBookmarks.All(o => o.MediaContentObject.ParentObject.AnimeMedium
                .GetIfInitialised(AnimeMedium.Unknown) != AnimeMedium.Unknown));
        ...
        public void BookmarkMangaTest()
        {
            ...
            Assert.IsTrue(lBookmarks.All(o =>
                !string.IsNullOrEmpty(o.MediaContentObject.ParentObject.Name.GetIfInitialised(string.Empty))));
            Assert.IsTrue(lBookmarks.All(o => o.MediaContentObject.ParentObject.MangaMedium
                .GetIfInitialised(MangaMedium.Unknown) != MangaMedium.Unknown));
            Assert.IsTrue(lBookmarks.All(o => o.BookmarkId != default(int)));
            Assert.IsTrue(lBookmarks.All(o => o.UserControlPanel == this._controlPanel));
        }
        ...
        {
            Bookmark<IMediaObject>[] lBookmarks = this._controlPanel.Bookmarks.ToArray();
            Assert.AreEqual(3, lBookmarks.Length);
            Assert.AreEqual(2, lBookmarks.Count(bookmark => bookmark.MediaContentObject.ParentObject is Anime));
            Assert.AreEqual(1, lBookmarks.Count(bookmark => bookmark.MediaContentObject.ParentObject is Manga));
            Assert.IsTrue(lBookmarks.All(o => o.MediaContentObject != null));
            Assert.IsTrue(lBookmarks.All(o => o.MediaContentObject.ContentIndex != default(int)));
            Assert.IsTrue(lBookmarks.All(o => o.MediaContentObject.ParentObject.Id != default(int)));
            Assert.IsTrue(lBookmarks.All(o =>
        ...
        public async Task CommentVotesTest()
        {
            ...
            Assert.IsTrue(lResult.Result.All(vote =>
                vote.Author.UserName.GetIfInitialised(string.Empty).Equals("KutoSan")));
        ...
        public void HistoryTest()
        {
            ...
            Assert.IsTrue(lHistory.All(o =>
                !string.IsNullOrEmpty(o.ContentObject.ParentObject.Name.GetIfInitialised(string.Empty))));
        }
        ...
        public async Task ToptenAnimeTest()
        {
            ...
            Assert.IsTrue(lResult.Result.All(o =>
                !string.IsNullOrEmpty(o.MediaObject.Name.GetIfInitialised(string.Empty))));
            Assert.IsTrue(lResult.Result.All(o => o.MediaObject.AnimeMedium
                .GetIfInitialised(AnimeMedium.Unknown) != AnimeMedium.Unknown));
        ...
        public async Task ToptenMangaTest()
        {
            ...
            Assert.IsTrue(lResult.Result.All(o =>
                !string.IsNullOrEmpty(o.MediaObject.Name.GetIfInitialised(string.Empty))));
            Assert.IsTrue(lResult.Result.All(o => o.MediaObject.MangaMedium
                .GetIfInitialised(MangaMedium.Unknown) != MangaMedium.Unknown));
            Assert.IsTrue(lResult.Result.All(o => o.UserControlPanel == this._controlPanel));
        }
    }
